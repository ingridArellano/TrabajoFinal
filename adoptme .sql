...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-06-2019 a las 17:09:40
...
(1, 'maria', 'hembra', 'mediano', '1', 12, 'fuerte', 'mediano', 2),
(2, 'marlilyn', 'macho', 'mediano', '2', 14, 'bajo', 'pequeño', 2),
(4, 'flavia', 'hembra', 'mediano', '1', 14, 'bajo', 'pequeño', 2);
...
--
ALTER TABLE `fichas`
  MODIFY `id_ficha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
